...
public class ScaffoldRestExceptionHandler {
    ...
    public R handleError(Throwable e) {
        ...
        return R.fail(ResultCode.INTERNAL_SERVER_ERROR, (ObjectUtils.isEmpty(e.getMessage()) ? ResultCode.INTERNAL_SERVER_ERROR
