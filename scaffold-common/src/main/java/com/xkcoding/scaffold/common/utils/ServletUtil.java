 ...
 * @author: yangkai.shen
 * @date: Created in 2019-03-12 16:55
...
public class ServletUtil {
    ...
    public static boolean isAjaxRequest(HttpServletRequest request) {
        ...
        if (StrUtil.containsIgnoreCase(accept, ContentType.JSON.toString())) {
            return true;
        }

        String xRequestedWith = request.getHeader("X-Requested-With");
        if (StrUtil.containsIgnoreCase(xRequestedWith, "XMLHttpRequest")) {
            return true;
        }
